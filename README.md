...
pygame, pydantic, `ephem` (for the almanac's sun and moon math), Pillow (to
decode the animated GIF weather icons), structlog, httpx and cachetools — the
unglamorous foundations everything above renders through.
